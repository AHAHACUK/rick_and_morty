...
class CharacterCardPage extends StatelessWidget {
  ...
  static const TextStyle episodesHeaderStyle =
  ...
  Widget build(BuildContext context) {
    ...
    FunctionLoaderBloc<List<Episode>> episodesLoader = FunctionLoaderBloc(
        () => episodeFetcher.fetchListByIds(character.episodesIds));
    episodesLoader.add(ContentLoadInit());
    return Scaffold(
        appBar: AppBar(),
                      ...
                      Expanded(
                          ...
                          child: Padding(
                              ...
                              child: Column(children: [
                                ...
                                const Text("Episodes",
                                    style: episodesHeaderStyle),
                                const SizedBox(height: 10),
                                Expanded(
                                    child: BlocBuilder<ContentLoaderBloc,
                                        ContentLoaderState>(
                                  bloc: episodesLoader,
                                  builder: (context, state) {
                                    if (state is ContentLoaded<List<Episode>>) {
